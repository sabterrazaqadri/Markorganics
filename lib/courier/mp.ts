 ...
 * M&P — UNVERIFIED.
 *
 * M&P integration is arranged through an account manager and is not publicly documented. Rather than guess an endpoint shape (a confidently wrong request
 * is worse than no request at all), this adapter satisfies the interface,
 * refuses every live call, and lists what it needs.
 *
 * TODO — supply from the M&P integration document:
 *   - M&P API base URL, and whether sandbox and production differ.
 ...
 */
export const MPAdapter = createScaffoldAdapter({
  id: "mp",
  name: "M&P",
  todo: [
    "M&P API base URL, and whether sandbox and production differ.",
