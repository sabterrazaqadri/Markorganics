 ...
 * BlueEx — UNVERIFIED.
 *
 * BlueEx uses an XML/JSON hybrid whose exact envelope depends on the account. Rather than guess an endpoint shape (a confidently wrong request
 * is worse than no request at all), this adapter satisfies the interface,
 * refuses every live call, and lists what it needs.
 *
 * TODO — supply from the BlueEx integration document:
 *   - BlueEx API base URL, and whether sandbox and production differ.
 ...
 */
export const BlueExAdapter = createScaffoldAdapter({
  id: "blueex",
  name: "BlueEx",
  todo: [
    "BlueEx API base URL, and whether sandbox and production differ.",
